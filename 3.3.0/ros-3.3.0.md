...
Introduce some new tables to simplify the model :

 * ros_common.trip
 * ros_common.trip_observer
 * ros_common.trip_vessel
 * ros_common.trip_vessel_fish_preservation_method
 * ros_common.trip_vessel_fish_storage_type
 * ros_common.trip_vessel_main_engines

to replace the following tables:

 * ros_common.general_vessel_and_trip_information
 * ros_common.observed_trip_summary
 * ros_common.observer_trip_details
 * ros_common.vessel_attributes
 * ros_common.vessel_electronics
 * ros_common.vessel_owner_and_personnel
 * ros_common.vessel_trip_details
