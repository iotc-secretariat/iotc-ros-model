create or replace view ros_analysis.v_ps_sf_w(gear, flag, year, month, grid_1, grid_5, species, species_group_code, fate, sex, weight_code, length_unit, size_bin, num_fish) as
    ...
    GROUP BY (COALESCE(fl.fleet_code, cl_co.code::character varying)), (date_part('year'::text, se.start_setting_date_and_time)), (date_part('month'::text, se.start_setting_date_and_time)),
             ...
             (floor(bi.estimated_weight_value)), bi.estimated_weight_unit;
...
create or replace view ros_analysis.v_ps_sf_l(gear, flag, year, month, grid_1, grid_5, species, species_group_code, fate, sex, length_code, length_unit, size_bin, num_fish) as
    ...
    WHERE od.vessel_type_code = 'SP'
    GROUP BY (COALESCE(fl.fleet_code, cl_co.code::character varying)), (date_part('year'::text, se.start_setting_date_and_time)), (date_part('month'::text, se.start_setting_date_and_time)),
             (ros_meta.to_grid_1(se.start_setting_latitude, se.start_setting_longitude)), (ros_meta.to_grid_5(se.start_setting_latitude, se.start_setting_longitude)), cl_sp.code, cl_sp.species_group_code, cl_fa.code, cl_sx.code,
             COALESCE(cl_le.code, cl_alt_le.code),
             COALESCE(bi.measured_length_unit, bi.alternative_measured_length_unit),
...
create or replace view ros_analysis.v_ps_ca(gear, flag, year, month, grid_1, grid_5, species, species_group_code, fate, observed_catch, catch_unit) as
    ...
    WHERE od.vessel_type_code = 'SP'
    GROUP BY (COALESCE(fl.fleet_code, cl_co.code::character varying)), (date_part('year'::text, se.start_setting_date_and_time)), (date_part('month'::text, se.start_setting_date_and_time)),
             (ros_meta.to_grid_1(se.start_setting_latitude, se.start_setting_longitude)), (ros_meta.to_grid_5(se.start_setting_latitude, se.start_setting_longitude)), cl_sp.code, cl_sp.species_group_code, cl_fa.code, ca.estimated_weight_unit;
...
create or replace view ros_views.v_ps_sf(operation_type, year, month, grid_1, grid_5, "TYPE", species_code, sex_code, length_type, length, num) as
