...
CREATE TABLE ros_ll.setting_operations (
    ...
    shark_lines_set boolean DEFAULT FALSE,
...
CREATE TABLE ros_ll.hauling_operations (
    id integer NOT NULL,
    bird_scaring_device_at_hauler boolean DEFAULT FALSE,
...
CREATE TABLE ros_meta.observers (
    ...
    basic_training boolean DEFAULT FALSE,
...
CREATE TABLE ros_common.carrier_vessel_identification (
    ...
    vessel_registration_original_id character varying(255),
...
CREATE TABLE ros_gn.additional_catch_details_on_ssi (
    id integer NOT NULL,
    brought_on_board boolean DEFAULT FALSE,
...
CREATE TABLE ros_gn.mitigation_measures (
    id integer NOT NULL,
    mitigation_measures boolean DEFAULT FALSE
);
...
CREATE TABLE ros_gn.special_equipment (
    id integer NOT NULL,
    net_drum_hauler boolean DEFAULT FALSE
);
...
CREATE TABLE ros_gn.tag_details (
    ...
    tag_recovery boolean DEFAULT FALSE,
    tag_release boolean DEFAULT FALSE,
...
CREATE TABLE ros_ll.additional_catch_details_on_ssi (
    ...
    brought_on_board boolean DEFAULT FALSE,
    light_attached_to_branchline boolean DEFAULT FALSE,
    photo_id character varying(255),
    revival boolean DEFAULT FALSE,
...
--
-- Name: leader_set; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: leader_set_id_seq; Type: SEQUENCE; Schema: ros_ll; Owner: ros-admin
--
...
CREATE TABLE ros_ll.mitigation_measures (
    id integer NOT NULL,
    branchline_weighted boolean DEFAULT FALSE,
    hooks_set_between_dusk_and_dawn boolean DEFAULT FALSE,
    minimum_deck_lighting_used boolean DEFAULT FALSE,
    number_of_tori_lines_deployed integer,
    percentage_of_branchlines_weighted double precision,
    hooks_pods boolean DEFAULT FALSE,
    average_sinker_weight_id integer,
...
CREATE TABLE ros_ll.special_equipment (
    id integer NOT NULL,
    bait_casting_machine boolean DEFAULT FALSE,
    line_hauler boolean DEFAULT FALSE,
    line_setter boolean DEFAULT FALSE
);
...
CREATE TABLE ros_ll.tori_line_details (
    ...
    streamers_reach_surface boolean DEFAULT FALSE,
...
CREATE VIEW ros_meta.v_ll_catches AS
 SELECT o.id AS trip_id,
  ...
  WHERE (f.code ~~ 'R%'::text)
  GROUP BY o.id, o.uid, fe.id, fe.event_original_id, sp.code,
        CASE
            WHEN (f.code IS NULL) THEN NULL::text
            ELSE concat(f.code, ' - ', f.name_en)
        END;
...
CREATE TABLE ros_pl.tuna_fishing_operations (
    id integer NOT NULL,
    bait_used boolean DEFAULT FALSE,
    end_event_date_and_time timestamp(6) without time zone,
...
CREATE TABLE ros_ps.cetaceans_whale_shark_sightings (
    id integer NOT NULL,
    caught_inside_the_net boolean DEFAULT FALSE,
    number_sighted integer,
    sighting_occurred_before_setting boolean DEFAULT FALSE,
    setting_operation_id integer,
    species_code character varying(16)
);
...
CREATE TABLE ros_ps.object_details (
    id integer NOT NULL,
    equipped_with_artificial_lights_at_deploy boolean DEFAULT FALSE,
    equipped_with_artificial_lights_on_retrieval boolean DEFAULT FALSE,
    buoy_identifier character varying(255),
...
CREATE TABLE ros_ps.special_equipment (
    id integer NOT NULL,
    power_block boolean DEFAULT FALSE,
    purse_winch boolean DEFAULT FALSE
);
...
ALTER TABLE ONLY ros_common.measured_lengths
    ADD CONSTRAINT uk_measured_lengths UNIQUE (unit, value, straight, type_of_measurement_code, measured_length_type_code, length_measuring_tool_code);
...
--
-- Name: leader_set ll_leader_set_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
CREATE INDEX index_ll_mitigation_measures_sinker_average_weight_id ON ros_ll.mitigation_measures USING btree (average_sinker_weight_id);
...
--
-- Name: reasons_for_days_lost fk_reasons_for_days_lost_inoperativity_reason; Type: FK CONSTRAINT; Schema: ros_common; Owner: ros-admin
--
...
--
-- Name: leader_set fk_ros_ll_leader_set_leader_material_type_code; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: leader_set fk_ros_ll_leader_total_branchline_maximum_length_id; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: leader_set fk_ros_ll_leader_total_branchline_minimum_length_id; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ONLY ros_ll.mitigation_measures
    ADD CONSTRAINT llmtgtnbrnchlnvrgwghtd FOREIGN KEY (average_sinker_weight_id) REFERENCES ros_common.weights(id);
