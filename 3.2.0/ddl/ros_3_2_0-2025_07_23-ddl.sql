...
--
-- Name: catch_details; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.catch_details OWNER TO "ros-admin";

--
-- Name: fishing_events; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
CREATE TABLE ros_ll.fishing_events (
    ...
    observer_data_id integer
);


ALTER TABLE ros_ll.fishing_events OWNER TO "ros-admin";

--
-- Name: observer_data; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--

CREATE TABLE ros_ll.observer_data (
    id integer NOT NULL,
    ...
    gear_specifications_id integer,
    vessel_and_trip_information_id integer,
    reporting_country_code character(3) NOT NULL
);


ALTER TABLE ros_ll.observer_data OWNER TO "ros-admin";

--
-- Name: setting_operations; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.setting_operations OWNER TO "ros-admin";

--
-- Name: specimens; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.specimens OWNER TO "ros-admin";
...
--
-- Name: catch_details; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
CREATE TABLE ros_ps.catch_details (
    ...
    comments text,
    estimated_catch_in_numbers integer,
    additional_catch_details_non_target_species_id integer,
    estimated_weight_id integer,
    fishing_event_id integer,
    type_of_fate_code character(2) NOT NULL,
    estimated_weight_sampling_method_code character(2),
...
ALTER TABLE ros_ps.catch_details OWNER TO "ros-admin";

--
-- Name: fishing_events; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.fishing_events OWNER TO "ros-admin";

--
-- Name: observer_data; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--

CREATE TABLE ros_ps.observer_data (
    id integer NOT NULL,
    complete smallint DEFAULT 0 NOT NULL,
    creation_time timestamp(6) without time zone NOT NULL,
    finalization_time timestamp(6) without time zone,
...
ALTER TABLE ros_ps.observer_data OWNER TO "ros-admin";

--
-- Name: setting_operations; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.setting_operations OWNER TO "ros-admin";
...
--
-- Name: hauling_operations; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.hauling_operations OWNER TO "ros-admin";
...
--
-- Name: specimens; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.specimens OWNER TO "ros-admin";
...
--
-- Name: observers; Type: TABLE; Schema: ros_meta; Owner: ros-admin
--

CREATE TABLE ros_meta.observers (
...
ALTER TABLE ros_meta.observers OWNER TO "ros-admin";

--
-- Name: observers_2_flags; Type: TABLE; Schema: ros_meta; Owner: ros-admin
--

CREATE TABLE ros_meta.observers_2_flags (
    iotc_number character(10) NOT NULL,
...
ALTER TABLE ros_meta.observers_2_flags OWNER TO "ros-admin";
...
--
-- Name: observer_data; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--

CREATE TABLE ros_gn.observer_data (
    id integer NOT NULL,
    complete smallint DEFAULT 0 NOT NULL,
    creation_time timestamp(6) without time zone NOT NULL,
    finalization_time timestamp(6) without time zone,
...
ALTER TABLE ros_gn.observer_data OWNER TO "ros-admin";
...
--
-- Name: observer_data; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--

CREATE TABLE ros_pl.observer_data (
    id integer NOT NULL,
    complete smallint DEFAULT 0 NOT NULL,
    creation_time timestamp(6) without time zone NOT NULL,
    finalization_time timestamp(6) without time zone,
...
ALTER TABLE ros_pl.observer_data OWNER TO "ros-admin";
...
--
-- Name: additional_catch_details_on_ssi; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.additional_catch_details_on_ssi OWNER TO "ros-admin";

--
-- Name: catch_details; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.catch_details OWNER TO "ros-admin";

--
-- Name: fishing_events; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.fishing_events OWNER TO "ros-admin";

--
-- Name: gear_specifications; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--

CREATE TABLE ros_gn.gear_specifications (
    id integer NOT NULL,
    special_equipment_id integer
);


ALTER TABLE ros_gn.gear_specifications OWNER TO "ros-admin";
...
--
-- Name: gillnet_configuration_net_web_colours; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.gillnet_configuration_net_web_colours OWNER TO "ros-admin";

--
-- Name: gillnet_configuration_stretched_mesh_sizes; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.gillnet_configuration_stretched_mesh_sizes OWNER TO "ros-admin";
...
--
-- Name: hauling_operations; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.hauling_operations OWNER TO "ros-admin";
...
--
-- Name: mitigation_measures; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.mitigation_measures OWNER TO "ros-admin";
...
ALTER TABLE ros_gn.observer_data ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: setting_operations; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.setting_operations OWNER TO "ros-admin";
...
--
-- Name: special_equipment; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--

CREATE TABLE ros_gn.special_equipment (
    id integer NOT NULL,
    net_drum_hauler smallint DEFAULT 0
);


ALTER TABLE ros_gn.special_equipment OWNER TO "ros-admin";

--
-- Name: gn_special_equipment_id_seq; Type: SEQUENCE; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ros_gn.special_equipment ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: specimens; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.specimens OWNER TO "ros-admin";
...
--
-- Name: tag_details; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.tag_details OWNER TO "ros-admin";
...
--
-- Name: mitigation_measures_mitigation_devices; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.mitigation_measures_mitigation_devices OWNER TO "ros-admin";

--
-- Name: observer_data_properties; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.observer_data_properties OWNER TO "ros-admin";

--
-- Name: observer_data_transhipment_details; Type: TABLE; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ros_gn.observer_data_transhipment_details OWNER TO "ros-admin";
...
--
-- Name: additional_catch_details_on_ssi; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.additional_catch_details_on_ssi OWNER TO "ros-admin";
...
--
-- Name: gear_specifications; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--

CREATE TABLE ros_ll.gear_specifications (
    id integer NOT NULL,
    storage character varying(255),
    general_gear_attributes_id integer,
    special_equipment_id integer,
    tori_line_detail_id integer
);


ALTER TABLE ros_ll.gear_specifications OWNER TO "ros-admin";

--
-- Name: gear_specifications_mitigation_device; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.gear_specifications_mitigation_device OWNER TO "ros-admin";

--
-- Name: general_gear_attributes; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--

CREATE TABLE ros_ll.general_gear_attributes (
    id integer NOT NULL,
...
ALTER TABLE ros_ll.general_gear_attributes OWNER TO "ros-admin";

--
-- Name: hauling_offal_disposal_positions; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.hauling_offal_disposal_positions OWNER TO "ros-admin";

--
-- Name: hauling_operations_stunning_methods; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--

CREATE TABLE ros_ll.hauling_operations_stunning_methods (
    hauling_operation_id integer NOT NULL,
    stunning_method_code character(2) NOT NULL
);


ALTER TABLE ros_ll.hauling_operations_stunning_methods OWNER TO "ros-admin";
...
--
-- Name: mitigation_measures; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.mitigation_measures OWNER TO "ros-admin";
...
--
-- Name: special_equipment; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--

CREATE TABLE ros_ll.special_equipment (
    id integer NOT NULL,
...
ALTER TABLE ros_ll.special_equipment OWNER TO "ros-admin";
...
--
-- Name: tag_details; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.tag_details OWNER TO "ros-admin";
...
--
-- Name: mitigation_measures_mitigation_devices; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.mitigation_measures_mitigation_devices OWNER TO "ros-admin";

--
-- Name: observer_data_properties; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.observer_data_properties OWNER TO "ros-admin";

--
-- Name: observer_data_transhipment_details; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ros_ll.observer_data_transhipment_details OWNER TO "ros-admin";

--
-- Name: setting_operations_target_species; Type: TABLE; Schema: ros_ll; Owner: ros-admin
--

CREATE TABLE ros_ll.setting_operations_target_species (
    setting_operations_id integer NOT NULL,
    target_species_code character varying(16)
);


ALTER TABLE ros_ll.setting_operations_target_species OWNER TO "ros-admin";
...
--
-- Name: focal_points; Type: TABLE; Schema: ros_meta; Owner: ros-admin
--

CREATE TABLE ros_meta.focal_points (
...
ALTER TABLE ros_meta.focal_points OWNER TO "ros-admin";

--
-- Name: focal_points_logins; Type: TABLE; Schema: ros_meta; Owner: ros-admin
--

CREATE TABLE ros_meta.focal_points_logins (
    id integer NOT NULL,
...
ALTER TABLE ros_meta.focal_points_logins OWNER TO "ros-admin";

--
-- Name: observers_logins; Type: TABLE; Schema: ros_meta; Owner: ros-admin
--

CREATE TABLE ros_meta.observers_logins (
    id integer NOT NULL,
    password_hash character(32) NOT NULL,
    last_login timestamp(6) without time zone
);
...
ALTER TABLE ros_meta.observers_logins OWNER TO "ros-admin";

--
-- Name: ros_focal_points_logins_id_seq; Type: SEQUENCE; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ros_meta.focal_points_logins ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE ros_meta.observers_logins ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: additional_catch_details_on_ssi; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.additional_catch_details_on_ssi OWNER TO "ros-admin";

--
-- Name: bait_fishing_event_pl_catch_detail; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.bait_fishing_event_pl_catch_detail OWNER TO "ros-admin";
...
--
-- Name: catch_details; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.catch_details OWNER TO "ros-admin";

--
-- Name: gear_specifications; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.gear_specifications OWNER TO "ros-admin";

--
-- Name: general_gear_attributes; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--

CREATE TABLE ros_pl.general_gear_attributes (
    id integer NOT NULL,
...
ALTER TABLE ros_pl.general_gear_attributes OWNER TO "ros-admin";
...
--
-- Name: object_details; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.object_details OWNER TO "ros-admin";

--
-- Name: observer_data_daily_activities; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--

CREATE TABLE ros_pl.observer_data_daily_activities (
    observer_data_id integer NOT NULL,
    daily_activity_id integer NOT NULL
);


ALTER TABLE ros_pl.observer_data_daily_activities OWNER TO "ros-admin";

--
-- Name: observer_data_properties; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--

CREATE TABLE ros_pl.observer_data_properties (
    observer_data_id integer NOT NULL,
    property_id integer NOT NULL
);


ALTER TABLE ros_pl.observer_data_properties OWNER TO "ros-admin";

--
-- Name: observer_data_transhipment_details; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.observer_data_transhipment_details OWNER TO "ros-admin";
...
ALTER TABLE ros_pl.general_gear_attributes ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE ros_pl.observer_data ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: special_equipment; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--

CREATE TABLE ros_pl.special_equipment (
    id integer NOT NULL,
...
ALTER TABLE ros_pl.special_equipment OWNER TO "ros-admin";

--
-- Name: pl_special_equipment_id_seq; Type: SEQUENCE; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ros_pl.special_equipment ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: specimens; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.specimens OWNER TO "ros-admin";
...
--
-- Name: tag_details; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.tag_details OWNER TO "ros-admin";
...
--
-- Name: tuna_fishing_operations; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.tuna_fishing_operations OWNER TO "ros-admin";
...
--
-- Name: tuna_fishing_event_pl_catch_detail; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.tuna_fishing_event_pl_catch_detail OWNER TO "ros-admin";
...
--
-- Name: tuna_fishing_operations_cl_school_sighting_cues; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ros_pl.tuna_fishing_operations_cl_school_sighting_cues OWNER TO "ros-admin";

--
-- Name: tuna_fishing_operations_target_species; Type: TABLE; Schema: ros_pl; Owner: ros-admin
--

CREATE TABLE ros_pl.tuna_fishing_operations_target_species (
    tuna_fishing_operation_id2 integer NOT NULL,
    target_species_code character varying(16)
);


ALTER TABLE ros_pl.tuna_fishing_operations_target_species OWNER TO "ros-admin";

--
-- Name: additional_catch_details_on_ssi; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.additional_catch_details_on_ssi OWNER TO "ros-admin";
...
--
-- Name: gear_specifications; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.gear_specifications OWNER TO "ros-admin";

--
-- Name: general_gear_attributes; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--

CREATE TABLE ros_ps.general_gear_attributes (
    id integer NOT NULL,
...
ALTER TABLE ros_ps.general_gear_attributes OWNER TO "ros-admin";

--
-- Name: object_details; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.object_details OWNER TO "ros-admin";

--
-- Name: observer_data_daily_activities; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.observer_data_daily_activities OWNER TO "ros-admin";

--
-- Name: observer_data_properties; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.observer_data_properties OWNER TO "ros-admin";

--
-- Name: observer_data_transhipment_details; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.observer_data_transhipment_details OWNER TO "ros-admin";
...
ALTER TABLE ros_ps.general_gear_attributes ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
ALTER TABLE ros_ps.observer_data ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: special_equipment; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--

CREATE TABLE ros_ps.special_equipment (
    id integer NOT NULL,
...
ALTER TABLE ros_ps.special_equipment OWNER TO "ros-admin";

--
-- Name: ps_special_equipment_id_seq; Type: SEQUENCE; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ros_ps.special_equipment ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: tag_details; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.tag_details OWNER TO "ros-admin";
...
--
-- Name: setting_operations_cl_school_sighting_cues; Type: TABLE; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ros_ps.setting_operations_cl_school_sighting_cues OWNER TO "ros-admin";
...
CREATE VIEW ros_views.v_alternate_ps_effort_fdays AS
 SELECT 'PS'::text AS gear_code,
    ...
    'FDAYS'::text AS effort_unit
   FROM ((ros_ps.observer_data o
     JOIN ros_ps.fishing_events fe ON ((fe.observer_data_id = o.id)))
     JOIN ros_ll.setting_operations s ON ((fe.setting_operation_id = s.id)))
  GROUP BY (date_part('year'::text, s.start_setting_date_and_time)), (date_part('month'::text, s.start_setting_date_and_time)), s.start_setting_latitude, s.start_setting_longitude;
...
--
-- Name: capacities uk_capacities; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.capacities
    ADD CONSTRAINT uk_capacities UNIQUE (unit, value);


--
-- Name: depths uk_depths; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.depths
    ADD CONSTRAINT uk_depths UNIQUE (unit, value);


--
-- Name: diameters uk_diameters; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.diameters
    ADD CONSTRAINT uk_diameters UNIQUE (unit, value);


--
-- Name: engines uk_engines; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.engines
    ADD CONSTRAINT uk_engines UNIQUE (unit, value);


--
-- Name: estimated_weights uk_estimated_weights; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.estimated_weights
    ADD CONSTRAINT uk_estimated_weights UNIQUE (unit, value, type_of_measurement_code, processing_type_code, weight_estimation_method_code);


--
-- Name: lengths uk_lengths; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.lengths
    ADD CONSTRAINT uk_lengths UNIQUE (unit, value);


--
-- Name: measured_lengths uk_measured_lengths; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.measured_lengths
    ADD CONSTRAINT uk_measured_lengths UNIQUE (unit, value, curved, type_of_measurement_code, measured_length_type_code, length_measuring_tool_code);


--
-- Name: ranges uk_ranges; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.ranges
    ADD CONSTRAINT uk_ranges UNIQUE (unit, value);


--
-- Name: sizes uk_sizes; Type: CONSTRAINT; Schema: ros_common; Owner: ros-admin
--

ALTER TABLE ONLY ros_common.sizes
    ADD CONSTRAINT uk_sizes UNIQUE (unit, value);
...
--
-- Name: additional_catch_details_on_ssi gn_additional_catch_details_on_ssi_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: catch_details gn_catch_details_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: fishing_events gn_fishing_events_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gear_specifications gn_gear_specifications_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gillnet_configuration_stretched_mesh_sizes gn_gillnet_configuration_stretched_mesh_sizes_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.gillnet_configuration_stretched_mesh_sizes
    ADD CONSTRAINT gn_gillnet_configuration_stretched_mesh_sizes_pkey PRIMARY KEY (gillnet_configuration_id_sms, stretched_mesh_size_id);


--
-- Name: hauling_operations gn_hauling_operations_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: mitigation_measures gn_mitigation_measures_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data gn_observer_data_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.observer_data
    ADD CONSTRAINT gn_observer_data_pkey PRIMARY KEY (id);


--
-- Name: observer_data gn_observer_data_uid_key; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: setting_operations gn_setting_operations_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: special_equipment gn_special_equipment_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.special_equipment
    ADD CONSTRAINT gn_special_equipment_pkey PRIMARY KEY (id);


--
-- Name: specimens gn_specimens_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: tag_details gn_tag_details_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data_properties observer_data_properties_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.observer_data_properties
    ADD CONSTRAINT observer_data_properties_pkey PRIMARY KEY (observer_data_id, property_id);


--
-- Name: observer_data_transhipment_details observer_data_transhipment_details_pkey; Type: CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.observer_data_transhipment_details
    ADD CONSTRAINT observer_data_transhipment_details_pkey PRIMARY KEY (observer_data_id, transhipment_detail_id);
...
--
-- Name: additional_catch_details_on_ssi ll_additional_catch_details_on_ssi_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: catch_details ll_catch_details_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: fishing_events ll_fishing_events_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: gear_specifications ll_gear_specifications_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes ll_general_gear_attributes_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.general_gear_attributes
    ADD CONSTRAINT ll_general_gear_attributes_pkey PRIMARY KEY (id);


--
-- Name: hauling_operations ll_hauling_operations_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: mitigation_measures ll_mitigation_measures_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data ll_observer_data_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.observer_data
    ADD CONSTRAINT ll_observer_data_pkey PRIMARY KEY (id);


--
-- Name: observer_data ll_observer_data_uid_key; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: setting_operations ll_setting_operations_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: special_equipment ll_special_equipment_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.special_equipment
    ADD CONSTRAINT ll_special_equipment_pkey PRIMARY KEY (id);


--
-- Name: specimens ll_specimens_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: tag_details ll_tag_details_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data_properties observer_data_properties_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.observer_data_properties
    ADD CONSTRAINT observer_data_properties_pkey PRIMARY KEY (observer_data_id, property_id);


--
-- Name: observer_data_transhipment_details observer_data_transhipment_details_pkey; Type: CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.observer_data_transhipment_details
    ADD CONSTRAINT observer_data_transhipment_details_pkey PRIMARY KEY (observer_data_id, transhipment_detail_id);
...
--
-- Name: focal_points pk_ros_focal_points_1; Type: CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.focal_points
    ADD CONSTRAINT pk_ros_focal_points_1 PRIMARY KEY (iotc_username);


--
-- Name: focal_points_logins pk_ros_focal_points_logins; Type: CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.focal_points_logins
    ADD CONSTRAINT pk_ros_focal_points_logins PRIMARY KEY (id);


--
-- Name: observers pk_ros_observers_1; Type: CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.observers
    ADD CONSTRAINT pk_ros_observers_1 PRIMARY KEY (iotc_number);


--
-- Name: observers_logins pk_ros_observers_logins; Type: CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.observers_logins
...
--
-- Name: observer_data_daily_activities observer_data_daily_activities_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data_daily_activities
    ADD CONSTRAINT observer_data_daily_activities_pkey PRIMARY KEY (observer_data_id, daily_activity_id);


--
-- Name: observer_data_properties observer_data_properties_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data_properties
    ADD CONSTRAINT observer_data_properties_pkey PRIMARY KEY (observer_data_id, property_id);


--
-- Name: observer_data_transhipment_details observer_data_transhipment_details_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data_transhipment_details
    ADD CONSTRAINT observer_data_transhipment_details_pkey PRIMARY KEY (observer_data_id, transhipment_detail_id);


--
-- Name: additional_catch_details_on_ssi pl_additional_catch_details_on_ssi_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: bait_fishing_event_pl_catch_detail pl_bait_fishing_event_pl_catch_detail_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.bait_fishing_event_pl_catch_detail
    ADD CONSTRAINT pl_bait_fishing_event_pl_catch_detail_pkey PRIMARY KEY (bait_fishing_event_id, catch_detail_id);


--
-- Name: catch_details pl_catch_details_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: gear_specifications pl_gear_specifications_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes pl_general_gear_attributes_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.general_gear_attributes
    ADD CONSTRAINT pl_general_gear_attributes_pkey PRIMARY KEY (id);


--
-- Name: object_details pl_object_details_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data pl_observer_data_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data
    ADD CONSTRAINT pl_observer_data_pkey PRIMARY KEY (id);


--
-- Name: observer_data pl_observer_data_uid_key; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: special_equipment pl_special_equipment_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.special_equipment
    ADD CONSTRAINT pl_special_equipment_pkey PRIMARY KEY (id);


--
-- Name: specimens pl_specimens_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tag_details pl_tag_details_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_event_pl_catch_detail pl_tuna_fishing_event_pl_catch_detail_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations pl_tuna_fishing_operations_pkey; Type: CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data_daily_activities observer_data_daily_activities_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data_daily_activities
    ADD CONSTRAINT observer_data_daily_activities_pkey PRIMARY KEY (observer_data_id, daily_activity_id);


--
-- Name: observer_data_properties observer_data_properties_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data_properties
    ADD CONSTRAINT observer_data_properties_pkey PRIMARY KEY (observer_data_id, property_id);


--
-- Name: observer_data_transhipment_details observer_data_transhipment_details_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data_transhipment_details
    ADD CONSTRAINT observer_data_transhipment_details_pkey PRIMARY KEY (observer_data_id, transhipment_detail_id);


--
-- Name: additional_catch_details_on_ssi ps_additional_catch_details_on_ssi_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details ps_catch_details_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: fishing_events ps_fishing_events_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: gear_specifications ps_gear_specifications_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes ps_general_gear_attributes_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.general_gear_attributes
    ADD CONSTRAINT ps_general_gear_attributes_pkey PRIMARY KEY (id);


--
-- Name: object_details ps_object_details_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data ps_observer_data_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data
    ADD CONSTRAINT ps_observer_data_pkey PRIMARY KEY (id);


--
-- Name: observer_data ps_observer_data_uid_key; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: setting_operations ps_setting_operations_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: special_equipment ps_special_equipment_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.special_equipment
    ADD CONSTRAINT ps_special_equipment_pkey PRIMARY KEY (id);


--
-- Name: specimens ps_specimens_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: tag_details ps_tag_details_pkey; Type: CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
CREATE INDEX index_gn_catch_details_identified_estimated_weight_id ON ros_gn.catch_details USING btree (estimated_weight_id);
...
CREATE INDEX index_gn_fishing_events_gn_observer_data_id ON ros_gn.fishing_events USING btree (observer_data_id);
...
CREATE INDEX index_gn_gear_specifications_gn_special_equipment_id ON ros_gn.gear_specifications USING btree (special_equipment_id);
...
CREATE INDEX index_gn_gillnet_configuration_stretched_mesh_sizes_id ON ros_gn.gillnet_configuration_stretched_mesh_sizes USING btree (gillnet_configuration_id_sms, stretched_mesh_size_id);
...
CREATE INDEX index_gn_observer_data_creator_id ON ros_gn.observer_data USING btree (creator_id);
...
CREATE INDEX index_gn_observer_data_gn_gear_specifications_id ON ros_gn.observer_data USING btree (gear_specifications_id);


--
-- Name: index_gn_observer_data_properties_observer_data_id; Type: INDEX; Schema: ros_gn; Owner: ros-admin
--

CREATE INDEX index_gn_observer_data_properties_observer_data_id ON ros_gn.observer_data_properties USING btree (observer_data_id);


--
-- Name: index_gn_observer_data_properties_property_id; Type: INDEX; Schema: ros_gn; Owner: ros-admin
--

CREATE INDEX index_gn_observer_data_properties_property_id ON ros_gn.observer_data_properties USING btree (property_id);
...
CREATE INDEX index_gn_observer_data_submitter_id ON ros_gn.observer_data USING btree (submitter_id);


--
-- Name: index_gn_observer_data_transhipment_details_observer_data_id; Type: INDEX; Schema: ros_gn; Owner: ros-admin
--

CREATE INDEX index_gn_observer_data_transhipment_details_observer_data_id ON ros_gn.observer_data_transhipment_details USING btree (observer_data_id);
...
CREATE INDEX index_gn_observer_data_vessel_and_trip_information_id ON ros_gn.observer_data USING btree (vessel_and_trip_information_id);


--
-- Name: index_gn_odt_details_transhipment_detail_id; Type: INDEX; Schema: ros_gn; Owner: ros-admin
--

CREATE INDEX index_gn_odt_details_transhipment_detail_id ON ros_gn.observer_data_transhipment_details USING btree (transhipment_detail_id);
...
CREATE INDEX index_gn_tag_details_tag_finder_id ON ros_gn.tag_details USING btree (tag_finder_id);
...
CREATE INDEX index_branchline_configurations_ll_gear_specifications_id ON ros_ll.branchline_configurations USING btree (gear_specifications_id);
...
CREATE INDEX index_ll_additional_catch_details_on_ssi_leader_thickness_id ON ros_ll.additional_catch_details_on_ssi USING btree (leader_thickness_id);
...
CREATE INDEX index_ll_fishing_events_ll_observer_data_id ON ros_ll.fishing_events USING btree (observer_data_id);
...
CREATE INDEX index_ll_gear_specifications_ll_general_gear_attributes_id ON ros_ll.gear_specifications USING btree (general_gear_attributes_id);
...
CREATE INDEX index_ll_gear_specifications_ll_special_equipment_id ON ros_ll.gear_specifications USING btree (special_equipment_id);
...
CREATE INDEX index_ll_general_gear_attributes_mainline_diameter_id ON ros_ll.general_gear_attributes USING btree (mainline_diameter_id);
...
CREATE INDEX index_ll_general_gear_attributes_mainline_length_id ON ros_ll.general_gear_attributes USING btree (mainline_length_id);
...
CREATE INDEX index_ll_mitigation_measures_hook_sinker_distance_id ON ros_ll.mitigation_measures USING btree (hook_sinker_distance_id);
...
CREATE INDEX index_ll_mitigation_measures_sinker_average_weight_id ON ros_ll.mitigation_measures USING btree (branchline_average_weight_id);
...
CREATE INDEX index_ll_observer_data_creator_id ON ros_ll.observer_data USING btree (creator_id);
...
CREATE INDEX index_ll_observer_data_ll_gear_specifications_id ON ros_ll.observer_data USING btree (gear_specifications_id);


--
-- Name: index_ll_observer_data_properties_observer_data_id; Type: INDEX; Schema: ros_ll; Owner: ros-admin
--

CREATE INDEX index_ll_observer_data_properties_observer_data_id ON ros_ll.observer_data_properties USING btree (observer_data_id);


--
-- Name: index_ll_observer_data_properties_property_id; Type: INDEX; Schema: ros_ll; Owner: ros-admin
--

CREATE INDEX index_ll_observer_data_properties_property_id ON ros_ll.observer_data_properties USING btree (property_id);
...
CREATE INDEX index_ll_observer_data_submitter_id ON ros_ll.observer_data USING btree (submitter_id);


--
-- Name: index_ll_observer_data_transhipment_details_observer_data_id; Type: INDEX; Schema: ros_ll; Owner: ros-admin
--

CREATE INDEX index_ll_observer_data_transhipment_details_observer_data_id ON ros_ll.observer_data_transhipment_details USING btree (observer_data_id);
...
CREATE INDEX index_ll_observer_data_vessel_and_trip_information_id ON ros_ll.observer_data USING btree (vessel_and_trip_information_id);


--
-- Name: index_ll_odt_details_transhipment_detail_id; Type: INDEX; Schema: ros_ll; Owner: ros-admin
--

CREATE INDEX index_ll_odt_details_transhipment_detail_id ON ros_ll.observer_data_transhipment_details USING btree (transhipment_detail_id);
...
CREATE INDEX index_ll_setting_operations_mainline_set_length_id ON ros_ll.setting_operations USING btree (mainline_set_length_id);
...
CREATE INDEX index_ll_tag_details_tag_finder_id ON ros_ll.tag_details USING btree (tag_finder_id);
...
CREATE INDEX index_bait_fishing_events_pl_object_detail_id ON ros_pl.bait_fishing_events USING btree (object_detail_id);
...
CREATE INDEX index_bait_fishing_events_pl_observer_data_id ON ros_pl.bait_fishing_events USING btree (observer_data_id);
...
CREATE INDEX index_lures_or_jiggers_by_type_pl_general_gear_attributes_id ON ros_pl.lures_or_jiggers_by_type USING btree (general_gear_attributes_id);
...
CREATE INDEX index_pl_bfe_pl_catch_detail_pl_bfe_id_pl_catch_detail_id ON ros_pl.bait_fishing_event_pl_catch_detail USING btree (bait_fishing_event_id, catch_detail_id);
...
CREATE INDEX index_pl_gear_specifications_pl_general_gear_attributes_id ON ros_pl.gear_specifications USING btree (general_gear_attributes_id);
...
CREATE INDEX index_pl_gear_specifications_pl_special_equipment_id ON ros_pl.gear_specifications USING btree (special_equipment_id);
...
CREATE INDEX index_pl_observer_data_creator_id ON ros_pl.observer_data USING btree (creator_id);


--
-- Name: index_pl_observer_data_daily_activities_daily_activity_id; Type: INDEX; Schema: ros_pl; Owner: ros-admin
--

CREATE INDEX index_pl_observer_data_daily_activities_daily_activity_id ON ros_pl.observer_data_daily_activities USING btree (daily_activity_id);


--
-- Name: index_pl_observer_data_daily_activities_observer_data_id; Type: INDEX; Schema: ros_pl; Owner: ros-admin
--

CREATE INDEX index_pl_observer_data_daily_activities_observer_data_id ON ros_pl.observer_data_daily_activities USING btree (observer_data_id);
...
CREATE INDEX index_pl_observer_data_pl_gear_specifications_id ON ros_pl.observer_data USING btree (gear_specifications_id);


--
-- Name: index_pl_observer_data_properties_observer_data_id; Type: INDEX; Schema: ros_pl; Owner: ros-admin
--

CREATE INDEX index_pl_observer_data_properties_observer_data_id ON ros_pl.observer_data_properties USING btree (observer_data_id);


--
-- Name: index_pl_observer_data_properties_property_id; Type: INDEX; Schema: ros_pl; Owner: ros-admin
--

CREATE INDEX index_pl_observer_data_properties_property_id ON ros_pl.observer_data_properties USING btree (property_id);
...
CREATE INDEX index_pl_observer_data_submitter_id ON ros_pl.observer_data USING btree (submitter_id);


--
-- Name: index_pl_observer_data_transhipment_details_observer_data_id; Type: INDEX; Schema: ros_pl; Owner: ros-admin
--

CREATE INDEX index_pl_observer_data_transhipment_details_observer_data_id ON ros_pl.observer_data_transhipment_details USING btree (observer_data_id);


--
-- Name: index_pl_observer_data_transhipment_pl_transhipment_detail_id; Type: INDEX; Schema: ros_pl; Owner: ros-admin
--

CREATE INDEX index_pl_observer_data_transhipment_pl_transhipment_detail_id ON ros_pl.observer_data_transhipment_details USING btree (transhipment_detail_id);
...
CREATE INDEX index_pl_observer_data_vessel_and_trip_information_id ON ros_pl.observer_data USING btree (vessel_and_trip_information_id);
...
CREATE INDEX index_pl_tag_details_tag_finder_id ON ros_pl.tag_details USING btree (tag_finder_id);
...
CREATE INDEX index_tuna_fishing_events_pl_observer_data_id ON ros_pl.tuna_fishing_events USING btree (observer_data_id);
...
CREATE INDEX index_current_details_ps_setting_operation_id ON ros_ps.current_details USING btree (setting_operation_id);
...
CREATE INDEX index_ps_cd_ps_additional_catch_details_non_target_species_id ON ros_ps.catch_details USING btree (additional_catch_details_non_target_species_id);
...
CREATE INDEX index_ps_fishing_events_ps_observer_data_id ON ros_ps.fishing_events USING btree (observer_data_id);
...
CREATE INDEX index_ps_gear_specifications_ps_general_gear_attributes_id ON ros_ps.gear_specifications USING btree (general_gear_attributes_id);
...
CREATE INDEX index_ps_gear_specifications_ps_special_equipment_id ON ros_ps.gear_specifications USING btree (special_equipment_id);
...
CREATE INDEX index_ps_general_gear_attributes_bunt_stretched_mesh_size_id ON ros_ps.general_gear_attributes USING btree (bunt_stretched_mesh_size_id);
...
CREATE INDEX index_ps_general_gear_attributes_maximum_net_depth_id ON ros_ps.general_gear_attributes USING btree (maximum_net_depth_id);
...
CREATE INDEX index_ps_general_gear_attributes_maximum_net_length_id ON ros_ps.general_gear_attributes USING btree (maximum_net_length_id);
...
CREATE INDEX index_ps_general_gear_attributes_mid_net_stretched_mesh_size_id ON ros_ps.general_gear_attributes USING btree (mid_net_stretched_mesh_size_id);
...
CREATE INDEX index_ps_general_gear_attributes_skiff_power_id ON ros_ps.general_gear_attributes USING btree (skiff_power_id);
...
CREATE INDEX index_ps_observer_data_creator_id ON ros_ps.observer_data USING btree (creator_id);


--
-- Name: index_ps_observer_data_daily_activities_daily_activity_id; Type: INDEX; Schema: ros_ps; Owner: ros-admin
--

CREATE INDEX index_ps_observer_data_daily_activities_daily_activity_id ON ros_ps.observer_data_daily_activities USING btree (daily_activity_id);


--
-- Name: index_ps_observer_data_daily_activities_observer_data_id; Type: INDEX; Schema: ros_ps; Owner: ros-admin
--

CREATE INDEX index_ps_observer_data_daily_activities_observer_data_id ON ros_ps.observer_data_daily_activities USING btree (observer_data_id);


--
-- Name: index_ps_observer_data_properties_observer_data_id; Type: INDEX; Schema: ros_ps; Owner: ros-admin
--

CREATE INDEX index_ps_observer_data_properties_observer_data_id ON ros_ps.observer_data_properties USING btree (observer_data_id);


--
-- Name: index_ps_observer_data_properties_property_id; Type: INDEX; Schema: ros_ps; Owner: ros-admin
--

CREATE INDEX index_ps_observer_data_properties_property_id ON ros_ps.observer_data_properties USING btree (property_id);
...
CREATE INDEX index_ps_observer_data_ps_gear_specifications_id ON ros_ps.observer_data USING btree (gear_specifications_id);
...
CREATE INDEX index_ps_observer_data_submitter_id ON ros_ps.observer_data USING btree (submitter_id);


--
-- Name: index_ps_observer_data_transhipment_details_observer_data_id; Type: INDEX; Schema: ros_ps; Owner: ros-admin
--

CREATE INDEX index_ps_observer_data_transhipment_details_observer_data_id ON ros_ps.observer_data_transhipment_details USING btree (observer_data_id);


--
-- Name: index_ps_observer_data_transhipment_ps_transhipment_detail_id; Type: INDEX; Schema: ros_ps; Owner: ros-admin
--

CREATE INDEX index_ps_observer_data_transhipment_ps_transhipment_detail_id ON ros_ps.observer_data_transhipment_details USING btree (transhipment_detail_id);
...
CREATE INDEX index_ps_observer_data_vessel_and_trip_information_id ON ros_ps.observer_data USING btree (vessel_and_trip_information_id);
...
CREATE INDEX index_ps_tag_details_tag_finder_id ON ros_ps.tag_details USING btree (tag_finder_id);
...
CREATE INDEX index_support_vessel_details_ps_setting_operation_id ON ros_ps.support_vessel_details USING btree (setting_operation_id);
...
--
-- Name: specimens ddtnlspcmndtlsnntrgtsp; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_gn_estimated_weight_sampling_method_code_gn_catch_detail; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_gn_fates_code_gn_catch_details; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_gn_gear_interaction_code_gn_additional_catch_details_on_; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_gn_handling_method_code_gn_additional_catch_details_on_s; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: mitigation_measures_mitigation_devices fk_ros_gn_mitigation_device_code_gn_mitigation_measures_mitigat; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gillnet_configuration_net_web_colours fk_ros_gn_net_colour_code_gn_gillnet_configuration_net_web_colo; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: hauling_operations fk_ros_gn_net_condition_code_gn_hauling_operations; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: setting_operations fk_ros_gn_net_configuration_code_gn_setting_operations; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: setting_operations fk_ros_gn_net_deploy_depth_code_gn_setting_operations; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: setting_operations fk_ros_gn_net_setting_strategy_code_gn_setting_operations; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data fk_ros_gn_reporting_country_code_gn_observer_data; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: hauling_operations fk_ros_gn_sampling_protocol_code_gn_hauling_operations; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_gn_species_code_gn_catch_details; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: tag_details fk_ros_gn_tag_type_code_gn_tag_details; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data gnbserverdatacreatorid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data gnbserverdatasbmtterid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data gnbsrvrdtgngrspcfctnsd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.observer_data
    ADD CONSTRAINT gnbsrvrdtgngrspcfctnsd FOREIGN KEY (gear_specifications_id) REFERENCES ros_gn.gear_specifications(id);


--
-- Name: observer_data_properties gnbsrvrdtprprtbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.observer_data_properties
    ADD CONSTRAINT gnbsrvrdtprprtbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_gn.observer_data(id);


--
-- Name: observer_data_properties gnbsrvrdtprprtsprprtyd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data_transhipment_details gnbsrvrdttrnshbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.observer_data_transhipment_details
    ADD CONSTRAINT gnbsrvrdttrnshbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_gn.observer_data(id);


--
-- Name: observer_data_transhipment_details gnbsrvrdttrnshpmntdtld; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: observer_data gnbsrvvsslndtrpnfrmtnd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: catch_details gnctchdtlsgnfshngvntid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: catch_details gnctchdtlsstmtdwightid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: fishing_events gnfshngvntgnsttngprtnd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: fishing_events gnfshngvntsgnbsrvrdtid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.fishing_events
    ADD CONSTRAINT gnfshngvntsgnbsrvrdtid FOREIGN KEY (observer_data_id) REFERENCES ros_gn.observer_data(id);


--
-- Name: fishing_events gnfshngvntsgnhlngprtnd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: fishing_events gnfshngvntsgnmtgtnmsrd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gillnet_configuration_net_web_colours gnglgngllntcnfgrtndnwc; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gillnet_configuration_stretched_mesh_sizes gnglgngllntcnfgrtndsms; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gillnet_configuration_stretched_mesh_sizes gngllntcnstrtchdmshszd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: specimens gngnddtnlctchdtlsnsssd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: gear_specifications gngrspcfctgnspclqpmntd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--

ALTER TABLE ONLY ros_gn.gear_specifications
    ADD CONSTRAINT gngrspcfctgnspclqpmntd FOREIGN KEY (special_equipment_id) REFERENCES ros_gn.special_equipment(id);


--
-- Name: mitigation_measures_mitigation_devices gnmtgtnmsrsmtmtgtnmsrd; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: specimens gnspcimensgntgdetailid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: specimens gnspcmnsbmtrcnfrmtonid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: specimens gnspcmnsgnctchdetailid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: specimens gnspcmnsgndprdtndtilid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
--
-- Name: tag_details gntagdetailstgfinderid; Type: FK CONSTRAINT; Schema: ros_gn; Owner: ros-admin
--
...
ALTER TABLE ONLY ros_ll.branchline_configurations
    ADD CONSTRAINT brnchlncnllgrspcfctnsd FOREIGN KEY (gear_specifications_id) REFERENCES ros_ll.gear_specifications(id);
...
ALTER TABLE ONLY ros_ll.branchlines_set
    ADD CONSTRAINT brnchlnssllsttngprtnsd FOREIGN KEY (setting_operations_id) REFERENCES ros_ll.setting_operations(id);
...
ALTER TABLE ONLY ros_ll.baits_by_conditions
    ADD CONSTRAINT btsbycndtllsttngprtnsd FOREIGN KEY (setting_operations_id) REFERENCES ros_ll.setting_operations(id);


--
-- Name: specimens ddtnlspcmndtlsnntrgtsp; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ll_bait_condition_code_ll_additional_catch_details_on_ss; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ll_dehooker_device_code_ll_additional_catch_details_on_s; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_ll_estimated_weight_sampling_method_code_ll_catch_detail; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_ll_fates_code_ll_catch_details; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ll_gear_interaction_code_ll_additional_catch_details_on_; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ll_handling_method_code_ll_additional_catch_details_on_s; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ll_leader_material_type_code_ll_additional_catch_details; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes fk_ros_ll_line_material_type_code_ll_general_gear_attributes; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: gear_specifications_mitigation_device fk_ros_ll_mitigation_device_code_ll_gear_specifications_mitigat; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: mitigation_measures_mitigation_devices fk_ros_ll_mitigation_device_code_ll_mitigation_measures_mitigat; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data fk_ros_ll_reporting_country_code_ll_observer_data; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: hauling_operations fk_ros_ll_sampling_protocol_code_ll_hauling_operations; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_ll_species_code_ll_catch_details; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: hauling_operations_stunning_methods fk_ros_ll_stunning_method_code_ll_hauling_operations_stunning_m; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.hauling_operations_stunning_methods
...
--
-- Name: tag_details fk_ros_ll_tag_type_code_ll_tag_details; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: setting_operations_target_species fk_ros_ll_target_species_code_ll_setting_operations_target_spec; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
ALTER TABLE ONLY ros_ll.hooks_by_type
    ADD CONSTRAINT hksbytypllsttngprtnsid FOREIGN KEY (setting_operations_id) REFERENCES ros_ll.setting_operations(id);
...
--
-- Name: observer_data llbserverdatacreatorid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data llbserverdatasbmtterid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data llbsrvrdtllgrspcfctnsd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.observer_data
    ADD CONSTRAINT llbsrvrdtllgrspcfctnsd FOREIGN KEY (gear_specifications_id) REFERENCES ros_ll.gear_specifications(id);


--
-- Name: observer_data_properties llbsrvrdtprprtbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.observer_data_properties
    ADD CONSTRAINT llbsrvrdtprprtbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_ll.observer_data(id);


--
-- Name: observer_data_properties llbsrvrdtprprtsprprtyd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data_transhipment_details llbsrvrdttrnshbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.observer_data_transhipment_details
    ADD CONSTRAINT llbsrvrdttrnshbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_ll.observer_data(id);


--
-- Name: observer_data_transhipment_details llbsrvrdttrnshpmntdtld; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: observer_data llbsrvvsslndtrpnfrmtnd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: catch_details llctchdtlsllfshngvntid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: catch_details llctchdtlsstmtdwightid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi llddtnlctchldrthcknssd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: fishing_events llfshngvntllsttngprtnd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: fishing_events llfshngvntsllbsrvrdtid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.fishing_events
    ADD CONSTRAINT llfshngvntsllbsrvrdtid FOREIGN KEY (observer_data_id) REFERENCES ros_ll.observer_data(id);


--
-- Name: fishing_events llfshngvntsllhlngprtnd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: fishing_events llfshngvntsllmtgtnmsrd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes llgnrlgrttrbmnlnlngthd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes llgnrlgrttrbtmnlndmtrd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: gear_specifications llgrspcfctionstrlndtld; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: gear_specifications_mitigation_device llgrspcfctllgrspcfctnd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: gear_specifications llgrspcfctllspclqpmntd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.gear_specifications
    ADD CONSTRAINT llgrspcfctllspclqpmntd FOREIGN KEY (special_equipment_id) REFERENCES ros_ll.special_equipment(id);


--
-- Name: gear_specifications llgrspcllgnrlgrttrbtsd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.gear_specifications
    ADD CONSTRAINT llgrspcllgnrlgrttrbtsd FOREIGN KEY (general_gear_attributes_id) REFERENCES ros_ll.general_gear_attributes(id);


--
-- Name: hauling_offal_disposal_positions llhlngffldsllhlngprtnd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: hauling_operations_stunning_methods llhlngprtnsllhlngprtnd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.hauling_operations_stunning_methods
    ADD CONSTRAINT llhlngprtnsllhlngprtnd FOREIGN KEY (hauling_operation_id) REFERENCES ros_ll.hauling_operations(id);


--
-- Name: specimens llllddtnlctchdtlsnsssd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: mitigation_measures llmtgtnbrnchlnvrgwghtd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: mitigation_measures llmtgtnmsrhksnkrdstncd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: mitigation_measures_mitigation_devices llmtgtnmsrsllmtgtnmsrd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: specimens llspcimenslltgdetailid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: specimens llspcmnsbmtrcnfrmtonid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: specimens llspcmnsllctchdetailid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: specimens llspcmnslldprdtndtilid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: setting_operations_target_species llsttngprllsttngprtnsd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--

ALTER TABLE ONLY ros_ll.setting_operations_target_species
    ADD CONSTRAINT llsttngprllsttngprtnsd FOREIGN KEY (setting_operations_id) REFERENCES ros_ll.setting_operations(id);


--
-- Name: setting_operations llsttngprtmnlnstlngthd; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: tag_details lltagdetailstgfinderid; Type: FK CONSTRAINT; Schema: ros_ll; Owner: ros-admin
--
...
--
-- Name: focal_points fk_ros_focal_points_ros_focal_points_logins; Type: FK CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.focal_points
    ADD CONSTRAINT fk_ros_focal_points_ros_focal_points_logins FOREIGN KEY (login_id) REFERENCES ros_meta.focal_points_logins(id);


--
-- Name: observers_2_flags fk_ros_meta_flag_code_ros_observers_2_flags; Type: FK CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.observers_2_flags
    ADD CONSTRAINT fk_ros_meta_flag_code_ros_observers_2_flags FOREIGN KEY (flag_code) REFERENCES refs_admin.countries(code);


--
-- Name: observers fk_ros_meta_nationality_code_ros_observers; Type: FK CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--
...
--
-- Name: focal_points fk_ros_meta_responsible_flag_code_ros_focal_points; Type: FK CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--
...
--
-- Name: observers_2_flags fk_ros_observers_2_flags_ros_observers; Type: FK CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.observers_2_flags
    ADD CONSTRAINT fk_ros_observers_2_flags_ros_observers FOREIGN KEY (iotc_number) REFERENCES ros_meta.observers(iotc_number) ON DELETE CASCADE;


--
-- Name: observers fk_ros_observers_ros_observers_logins; Type: FK CONSTRAINT; Schema: ros_meta; Owner: ros-admin
--

ALTER TABLE ONLY ros_meta.observers
    ADD CONSTRAINT fk_ros_observers_ros_observers_logins FOREIGN KEY (login_id) REFERENCES ros_meta.observers_logins(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY ros_pl.bait_fishing_operations_cl_school_sighting_cues
    ADD CONSTRAINT btfshngprtplfshngprtnd FOREIGN KEY (fishing_operation_id) REFERENCES ros_pl.bait_fishing_operations(id);
...
ALTER TABLE ONLY ros_pl.bait_fishing_events
    ADD CONSTRAINT btfshngvntsplbjctdtlid FOREIGN KEY (object_detail_id) REFERENCES ros_pl.object_details(id);
...
ALTER TABLE ONLY ros_pl.bait_fishing_events
    ADD CONSTRAINT btfshngvntsplbsrvrdtid FOREIGN KEY (observer_data_id) REFERENCES ros_pl.observer_data(id);
...
--
-- Name: specimens ddtnlspcmndtlsnntrgtsp; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_pl_estimated_weight_sampling_method_code_pl_catch_detail; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_pl_fates_code_pl_catch_details; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_pl_gear_interaction_code_pl_additional_catch_details_on_; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_pl_handling_method_code_pl_additional_catch_details_on_s; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes fk_ros_pl_hook_type_code_pl_general_gear_attributes; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data fk_ros_pl_reporting_country_code_pl_observer_data; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations fk_ros_pl_sampling_protocol_code_pl_tuna_fishing_operations; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations_cl_school_sighting_cues fk_ros_pl_school_sighting_cue_code_pl_tuna_fishing_operations_c; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_pl_species_code_pl_catch_details; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tag_details fk_ros_pl_tag_type_code_pl_tag_details; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations_target_species fk_ros_pl_target_species_code_pl_tuna_fishing_operations_target; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations fk_ros_pl_wind_scale_code_pl_tuna_fishing_operations; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data_properties gnbsrvrdtprprtbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data_properties gnbsrvrdtprprtsprprtyd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
ALTER TABLE ONLY ros_pl.lures_or_jiggers_by_type
    ADD CONSTRAINT lrsrjggplgnrlgrttrbtsd FOREIGN KEY (general_gear_attributes_id) REFERENCES ros_pl.general_gear_attributes(id);


--
-- Name: observer_data plbserverdatacreatorid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data plbserverdatasbmtterid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data_daily_activities plbsrvrdtdlycdlyctvtyd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data_daily_activities plbsrvrdtdlyctbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data_daily_activities
    ADD CONSTRAINT plbsrvrdtdlyctbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_pl.observer_data(id);


--
-- Name: observer_data plbsrvrdtplgrspcfctnsd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data
    ADD CONSTRAINT plbsrvrdtplgrspcfctnsd FOREIGN KEY (gear_specifications_id) REFERENCES ros_pl.gear_specifications(id);


--
-- Name: observer_data_transhipment_details plbsrvrdttrnshbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.observer_data_transhipment_details
    ADD CONSTRAINT plbsrvrdttrnshbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_pl.observer_data(id);


--
-- Name: observer_data_transhipment_details plbsrvrdttrnshpmntdtld; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: observer_data plbsrvvsslndtrpnfrmtnd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: bait_fishing_event_pl_catch_detail plbtfshngplbtfshngvntd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: bait_fishing_event_pl_catch_detail plbtfshngvntplctchdtld; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.bait_fishing_event_pl_catch_detail
    ADD CONSTRAINT plbtfshngvntplctchdtld FOREIGN KEY (catch_detail_id) REFERENCES ros_pl.catch_details(id);


--
-- Name: catch_details plctchdtlsstmtdwightid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: gear_specifications plgrspcfctplspclqpmntd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.gear_specifications
    ADD CONSTRAINT plgrspcfctplspclqpmntd FOREIGN KEY (special_equipment_id) REFERENCES ros_pl.special_equipment(id);


--
-- Name: gear_specifications plgrspcplgnrlgrttrbtsd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.gear_specifications
    ADD CONSTRAINT plgrspcplgnrlgrttrbtsd FOREIGN KEY (general_gear_attributes_id) REFERENCES ros_pl.general_gear_attributes(id);


--
-- Name: specimens plplddtnlctchdtlsnsssd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: specimens plspcimenspltgdetailid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: specimens plspcmnsbmtrcnfrmtonid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: specimens plspcmnsplctchdetailid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: specimens plspcmnspldprdtndtilid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tag_details pltagdetailstgfinderid; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_event_pl_catch_detail pltnfshngpltnfshngvntd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations_cl_school_sighting_cues pltnfshngpplfshngprtnd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations pltnfshngprtbtndcndtnd; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_event_pl_catch_detail pltnfshngvntplctchdtld; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--
...
--
-- Name: tuna_fishing_operations_target_species pltnfshpltnfshngprtnd2; Type: FK CONSTRAINT; Schema: ros_pl; Owner: ros-admin
--

ALTER TABLE ONLY ros_pl.tuna_fishing_operations_target_species
    ADD CONSTRAINT pltnfshpltnfshngprtnd2 FOREIGN KEY (tuna_fishing_operation_id2) REFERENCES ros_pl.tuna_fishing_operations(id);
...
ALTER TABLE ONLY ros_pl.tuna_fishing_events
    ADD CONSTRAINT tnfshngvntsplbsrvrdtid FOREIGN KEY (observer_data_id) REFERENCES ros_pl.observer_data(id);
...
ALTER TABLE ONLY ros_ps.current_details
    ADD CONSTRAINT crrntdtlspssttngprtnid FOREIGN KEY (setting_operation_id) REFERENCES ros_ps.setting_operations(id);
...
--
-- Name: specimens ddtnlspcmndtlsnntrgtsp; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_ps_estimated_weight_sampling_method_code_ps_catch_detail; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: object_details fk_ros_ps_fad_raft_design_code_ps_object_details; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: object_details fk_ros_ps_fad_tail_design_code_ps_object_details; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_ps_fates_code_ps_catch_details; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: setting_operations fk_ros_ps_first_school_detection_method_code_ps_setting_operati; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ps_gear_interaction_code_ps_additional_catch_details_on_; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: additional_catch_details_on_ssi fk_ros_ps_handling_method_code_ps_additional_catch_details_on_s; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data fk_ros_ps_reporting_country_code_ps_observer_data; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: setting_operations_cl_school_sighting_cues fk_ros_ps_school_sighting_cue_code_ps_setting_operations_cl_sch; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details fk_ros_ps_species_code_ps_catch_details; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: tag_details fk_ros_ps_tag_type_code_ps_tag_details; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: setting_operations fk_ros_ps_wind_scale_code_ps_setting_operations; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data psbserverdatacreatorid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data psbserverdatasbmtterid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data_daily_activities psbsrvrdtdlycdlyctvtyd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data_daily_activities psbsrvrdtdlyctbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data_daily_activities
    ADD CONSTRAINT psbsrvrdtdlyctbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_ps.observer_data(id);


--
-- Name: observer_data_properties psbsrvrdtprprtbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data_properties
    ADD CONSTRAINT psbsrvrdtprprtbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_ps.observer_data(id);


--
-- Name: observer_data_properties psbsrvrdtprprtsprprtyd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data psbsrvrdtpsgrspcfctnsd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data
    ADD CONSTRAINT psbsrvrdtpsgrspcfctnsd FOREIGN KEY (gear_specifications_id) REFERENCES ros_ps.gear_specifications(id);


--
-- Name: observer_data_transhipment_details psbsrvrdttrnshbsrvrdtd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.observer_data_transhipment_details
    ADD CONSTRAINT psbsrvrdttrnshbsrvrdtd FOREIGN KEY (observer_data_id) REFERENCES ros_ps.observer_data(id);


--
-- Name: observer_data_transhipment_details psbsrvrdttrnshpmntdtld; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: observer_data psbsrvvsslndtrpnfrmtnd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details psctchdtlspsfshngvntid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details psctchdtlsstmtdwightid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: catch_details psddtnlctchdtlsnntrgts; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.catch_details
    ADD CONSTRAINT psddtnlctchdtlsnntrgts FOREIGN KEY (additional_catch_details_non_target_species_id) REFERENCES ros_common.additional_details_on_non_target_species(id);


--
-- Name: fishing_events psfshngvntpssttngprtnd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: fishing_events psfshngvntspsbsrvrdtid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.fishing_events
    ADD CONSTRAINT psfshngvntspsbsrvrdtid FOREIGN KEY (observer_data_id) REFERENCES ros_ps.observer_data(id);


--
-- Name: general_gear_attributes psgnrlbntstrtchdmshszd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes psgnrlgrttmxmmntlngthd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes psgnrlgrttrbtsskffpwrd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes psgnrlgrttrmxmmntdpthd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: general_gear_attributes psgnrmdntstrtchdmshszd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: gear_specifications psgrspcfctpsspclqpmntd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.gear_specifications
    ADD CONSTRAINT psgrspcfctpsspclqpmntd FOREIGN KEY (special_equipment_id) REFERENCES ros_ps.special_equipment(id);


--
-- Name: gear_specifications psgrspcpsgnrlgrttrbtsd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--

ALTER TABLE ONLY ros_ps.gear_specifications
    ADD CONSTRAINT psgrspcpsgnrlgrttrbtsd FOREIGN KEY (general_gear_attributes_id) REFERENCES ros_ps.general_gear_attributes(id);


--
-- Name: specimens pspsddtnlctchdtlsnsssd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: specimens psspcimenspstgdetailid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: specimens psspcmnsbmtrcnfrmtonid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: specimens psspcmnspsctchdetailid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: setting_operations pssttngprtnspsbjctdtld; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: setting_operations_cl_school_sighting_cues pssttngprtpssttngprtnd; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
--
-- Name: tag_details pstagdetailstgfinderid; Type: FK CONSTRAINT; Schema: ros_ps; Owner: ros-admin
--
...
ALTER TABLE ONLY ros_ps.support_vessel_details
    ADD CONSTRAINT spprtvssldpssttngprtnd FOREIGN KEY (setting_operation_id) REFERENCES ros_ps.setting_operations(id);
